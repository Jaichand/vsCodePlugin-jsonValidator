...
export function activate(context: vscode.ExtensionContext) {
  ...
  console.log('Congratulations, your extension "JSONFormatter" is now active!');
  ...
  const disposable = vscode.commands.registerCommand(
    ...
    async () => {
      ...
      vscode.window.showInformationMessage("SiFive test Starting");
